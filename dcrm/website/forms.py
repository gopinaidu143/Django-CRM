...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        unwanted_fields = ['password_based_authentication']  # Example field to be removed
...
class AddRecordForm(forms.ModelForm):
    ...
    phone = forms.CharField(widget=forms.widgets.TextInput(attrs={'placeholder':'Phone Number','class':'form-control'}),label='') 
